...
main()
{
    ...
    cout <<(g>h);// akan menghasilkan 0 (false),karena 1 kurang daari 2
    cout << endl;
    cout <<(g<h);// akan menghasilkan 1 (true), karena 1 kurang dari 2
    cout << endl;
    cout <<(g==h);// akan menghasilkan nilai 0(false), karena q tidak sama dengan 2
    cout << endl;
